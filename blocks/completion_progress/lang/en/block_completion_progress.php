...
$string['coursenamecolour'] = 'Dashboard course title colour';
$string['coursenamecolour_desc'] = 'Colour used for the Dashboard course title text shown in the Completion Progress block.';
