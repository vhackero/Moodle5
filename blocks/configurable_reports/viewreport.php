...
$hasfilters = $reportclass->has_filters();
$hasactivefilterrequest = $reportclass->has_active_filter_request();
if ($download && $hasfilters && !$hasactivefilterrequest) {
    throw new moodle_exception('filter_required_to_run_report', 'block_configurable_reports');
}
if (!$hasfilters || $hasactivefilterrequest) {
