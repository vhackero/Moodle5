...
$string['exportcourse'] = 'Course';
$string['exportevaluatedteacher'] = 'Evaluated teacher';
$string['exportextractiondate'] = 'Extraction date';
$string['exportinstitution'] = 'Institution';
$string['exportreportgraph'] = 'Report graph';
...
$string['filter_required_to_run_report'] = 'Select a filter and click Apply to generate the report.';
...
$string['filteruserbyrolecourse'] = 'User by group and role (group id)';
$string['filteruserbyrolecourse_option'] = '{$a->user} ({$a->group})';
$string['filteruserbyrolecourse_select'] = 'User by group and role - group id ({$a})';
$string['filteruserbyrolecourse_summary'] = 'Filter by group id using users with the role {$a} in the current course. Use: %%FILTER_USERBYROLEGROUP:prefix_groups.id%%';
$string['filteruserbyrolecourse_summary_norole'] = 'Filter by group id using users with a configured role';
$string['userbyrolecourse'] = 'User by group and role (group id)';
$string['filteruserbyrolegroupuser'] = 'User by group and role (user id)';
$string['filteruserbyrolegroupuser_option'] = '{$a->user} ({$a->groups})';
$string['filteruserbyrolegroupuser_select'] = 'User by group and role - user id ({$a})';
$string['filteruserbyrolegroupuser_summary'] = 'Filter by user id using users with the role {$a} in at least one group of the current course. Use: %%FILTER_USERBYROLEGROUPUSER:prefix_user.id%%';
$string['filteruserbyrolegroupuser_summary_norole'] = 'Filter by user id using users with a configured role in at least one group';
$string['userbyrolegroupuser'] = 'User by group and role (user id)';
