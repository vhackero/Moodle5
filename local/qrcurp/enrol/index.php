...
$defaulcategory = get_config("local_qrcurp","defaultcategoryid");
...
$fechaLimiteRegistro = get_config('local_qrcurp','dateregistro');
...
$fechaLimiteRegistro = strtotime(get_config('local_qrcurp','dateregistro')); //Fecha limite de registro en config del pluggin
$fechaporperidos = get_config('local_qrcurp','dateperiodos'); //Fecha de apertura y cierre por peridos
$fechaActual = strtotime(date('d-m-Y'));
$menssage = get_config('local_qrcurp','textregistro'); //Texto pasado el límite de registro
