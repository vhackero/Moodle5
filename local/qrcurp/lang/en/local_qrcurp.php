...
$string['iconuploadheading'] = 'Carga de imágenes para registros';
$string['iconuploadlinklabel'] = 'Ir a la página para subir imágenes';
$string['iconuploaddescription'] = 'Para cargar o actualizar imágenes de registro, usa el siguiente enlace: {$a}';
