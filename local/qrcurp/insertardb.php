...
$remotedbhost = get_config('local_qrcurp','dbhost');
$remotedbname = get_config('local_qrcurp','dbname');
$remotedbuser = get_config('local_qrcurp','dbuser');
$remotedbpass = get_config('local_qrcurp', 'dbpass');
$remoteport = get_config('local_qrcurp', 'dbport');
