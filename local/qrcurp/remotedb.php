...
$remotedbhost = get_config('local_qrcurp','dbhost');    //HOST
$remotedbname = get_config('local_qrcurp','dbname');    //NOMBRE DE LA BD EXTERNA
$remotedbtable = get_config('local_qrcurp','dbtable');  //NOMBRE DE LA TABLA
$remotedbuser = get_config('local_qrcurp','dbuser');    //USUARIO DE LA DB EXTERNA
$remotedbpass = get_config('local_qrcurp', 'dbpass');   //CONTRASEÑA DE LA DB EXTERNA
$remoteport = get_config('local_qrcurp', 'dbport');     //PUERTO DE LA DB EXTERNA
$remoteinsertdb =get_config('local_qrcurp','dbinsert'); //PARA SABER SI SE AGREGARAN LOS DATOS A LA BD EXTERNA
