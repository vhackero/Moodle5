...
//$NAMEPLATAFORMREGISTRY = "NAME";
//$NAMEEXTERNALDBREGISTRY = "NAME2";
...
$string['nameplataforminfo'] = "Este aparecerá en todos los textos, haciendo referencia al mismo, incluso en el envio de correos, ejemplo: Aula virtual UnADM,CVL,etc.";
...
//Mensajes emergentes
$string['noregismoodle'] = "Tus datos no han sido registrados previamente, por favor da clic en aceptar para registrar en el sitio de $NAMEPLATAFORMREGISTRY.";
$string['noregisexdb'] = "Tus datos no han sido registrados previamente, por favor da clic en aceptar para registrar en el sitio de $NAMEPLATAFORMREGISTRY";
$string['regismoodleyexdb'] = "Ya existe una cuenta registrada en $NAMEEXTERNALDBREGISTRY y en el sitio de $NAMEPLATAFORMREGISTRY, inicia sesión.";
$string['regismoodlenotexdb'] = "No existe una cuenta registrada en el sitio de $NAMEPLATAFORMREGISTRY ni en $NAMEEXTERNALDBREGISTRY, registrarse para continuar.";
$string['regismoodle'] = "Ya existe una cuenta registrada en el sitio de $NAMEPLATAFORMREGISTRY, inicia sesión";
$string['regismoodlenotexdb0'] = "No existe una cuenta registrada en $NAMEEXTERNALDBREGISTRY pero si en el sitio de $NAMEPLATAFORMREGISTRY, inicia sesión.";
$string['regismoodlenotexdb1'] = "No existe una cuenta registrada en $NAMEEXTERNALDBREGISTRY pero si en el sitio de $NAMEPLATAFORMREGISTRY, registrarse en $NAMEEXTERNALDBREGISTRY.";
$string['errorconsulta'] = "No existe una cuenta registrada en $NAMEEXTERNALDBREGISTRY pero si en el sitio de $NAMEPLATAFORMREGISTRY, registrarse en $NAMEEXTERNALDBREGISTRY.";
$string['correoregimoodle'] = "Existe una cuenta registrada con ese correo en el sitio de $NAMEPLATAFORMREGISTRY, intentalo con otro.";
