...
$ordeAlfabetico = get_config("local_registry","coursealphaorder"); //Ordenara los cursos alfabéticamente
$ordeby = '';
if($ordeAlfabetico){
...
$acceptcoursesdbexternal = get_config("local_registry","acceptcoursesdbexternal");
$muestraCursosEnEspacifico =  get_config('local_registry','showuniquecourses');    //aceptará registro en cursos en epecífico
...
if($acceptcoursesdbexternal == 1){
    ...
    $accessbyroltocourse = get_config("local_registry","accessbyroltocourse");
...
$idscourses =  get_config('local_registry','showuniquecourseslist');    //id de los cursos
$idsArray = [];
